# Os operadores lógicos são símbolos especiais usados para combinar ou manipular valores lógicos (Verdadeiro ou Falso). 
# Eles permitem criar expressões lógicas que ajudam a controlar o fluxo de um programa ou a tomar decisões com base em condições específicas.
...
# Exemplos Combinados
print("Exemplos combinados:")
x = 5
print("x > 0 and x < 10:", x > 0 and x < 10)  # Retorna True, pois x é maior que 0 e menor que 10
print("x < 0 or x % 2 == 0:", x < 0 or x % 2 == 0)  # Retorna False, pois x não é menor que 0
print("not(x == 5):", not (x == 5))  # Retorna False, pois x é igual a 5
