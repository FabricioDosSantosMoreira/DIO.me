# Os operadores de identidade, is e is not, são utilizados para verificar se duas variáveis 
# estão se referindo ao mesmo objeto na memória.
...
# Operador 'is' retorna True se as duas variáveis apontarem para o mesmo objeto na memória
print("Operador 'is':")
...
# Operador 'is not' retorna True se as duas variáveis não apontarem para o mesmo objeto na memória
print("\nOperador 'is not':")
