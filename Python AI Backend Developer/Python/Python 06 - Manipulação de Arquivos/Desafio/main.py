...
class Main():
        ...
        def envelope(*args, **kwargs):
            ...
            try:
                with open(ROOT_PATH / 'log.txt', 'a', encoding='utf-8') as log:
                    log.write(f"- - -> {data_hora}; Função: {func.__name__}. Ecxecutada com argumentos {args} e {kwargs}. Retornou: {resultado}\n")
    ...
    def criar_cliente(self, clientes: list) -> None:
        ...
        if self.existe_cliente(cpf, clientes): # Já existe um cliente com este mesmo cpf?
