...
# │         virtualenv. Ele ajuda no processo de gerenciamento de dependências
# │         e ambiente de desenvolvimento, garantindo que as versões corretas 
# │         dos pacotes sejam instaladas e mantendo um controle organizado  
