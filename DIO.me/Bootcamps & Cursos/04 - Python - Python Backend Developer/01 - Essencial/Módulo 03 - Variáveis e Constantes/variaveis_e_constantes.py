...
# - - - - > Variáveis:
#               Variáveis são espaços de memória reservados para armazenar dados  
#           manipuláveis durante a execução do programa. Elas possuem um nome 
#           que as identifica e um valor associado que pode ser modificado ao 
#           longo do programa.

# - - - - > Constantes:
#               Constantes, são valores que não podem ser alterados durante a 
#           execução do programa. No Python, não existe um tipo de dado  
#           específico para constantes, mas a convenção é que nomes de 
#           variáveis em letras maiúsculas sejam tratados como constantes, 
