...
#                 Conversão de tipos de dados é o processo de transformar um 
#             tipo de dado em outro. Isso é útil para realizar operações que 
#             envolvem diferentes tipos de dados ou para garantir a 
