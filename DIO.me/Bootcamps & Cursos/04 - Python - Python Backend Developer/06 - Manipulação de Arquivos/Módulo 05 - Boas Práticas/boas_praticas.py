...
#             leitura, escrita e manipulação de arquivos em Python.
...
try:
    with open(ROOT_PATH / "util/boas_praticas.txt", "r", encoding='utf-8') as arquivo:
        
        conteudo = arquivo.read()
        print(f"\nConteúdo do arquivo: \n{conteudo}")

    # NOTE: Neste ponto, o 'arquivo' já foi fechado automaticamente
    #       pelo bloco 'with', mesmo que ocorra uma exceção
