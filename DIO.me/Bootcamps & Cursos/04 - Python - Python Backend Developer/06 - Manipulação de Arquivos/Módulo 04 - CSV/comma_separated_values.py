...
#                 Arquivos CSV (Comma-Separated Values) são arquivos de
#             texto que armazenam dados em formato tabular, onde cada  
#             linha corresponde a uma linha da tabela e os valores de  
#             cada linha são separados por vírgulas.
...
try:
    with open(caminho, newline="", encoding='utf-8') as arquivo_csv:
        ...
        print(f"Cabeçalho do CSV: {reader.fieldnames}")
