...
// │             Crie uma classe chamada 'tarefas' que possui uma lista de tarefas como atributo. Cada
// │         tarefa é representada por uma classe chamada 'Tarefa' que possui um atributo de descrição.
...
// │
// │             * exibirDescricoesTarefas(): 
// │                   Exibe a descrição de todas as tarefas na lista.
// │
// │
// │
// └───────> Código:
